...
class FlinkKafkaInput(PTransform):
    ...
    def from_runner_api_parameter(_unused_ptransform, spec_parameter,
        _unused_context):
        ...
        instance.max_out_of_orderness_millis = payload[
            'max_out_of_orderness_millis']
        instance.start_from_timestamp_millis = payload[
            'start_from_timestamp_millis']
