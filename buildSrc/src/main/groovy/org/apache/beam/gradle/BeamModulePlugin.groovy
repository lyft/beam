...
"""
  ...
  void apply(Project project) {
    ...
    project.version = '2.21.0-lyft20200831tests3kinesissource2'
    ...
    project.ext.library = [
      ...
      maven: [
        ...
        maven_surefire_plugin: "maven-plugins:maven-surefire-plugin:2.21.0-lyft20200831tests3kinesissource2",
      ],
    ]
