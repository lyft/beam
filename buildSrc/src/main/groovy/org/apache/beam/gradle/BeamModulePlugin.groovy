...
"""
  ...
  void apply(Project project) {
    ...
    project.version = '2.21.0-lyft20201124tests3source'
    ...
    project.ext.library = [
      ...
      maven: [
        ...
        maven_surefire_plugin: "maven-plugins:maven-surefire-plugin:2.21.0-lyft20201124tests3source-lyft20201124{TEST_BUILD}",
      ],
    ]
